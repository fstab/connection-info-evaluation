...
| Client Span `server.address` | `server-node-express.namespace-b`<br>JavaScript instrumentation uses the deprecated label name `net.peer.name`. |
| Client Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.peer.port`.                            |
| Server Span `server.address` | `server-node-express.namespace-b`<br>JavaScript instrumentation uses the deprecated label name `net.host.name`. |
| Server Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.host.port`.                            |
...
| Client Span `server.address` | `10.244.1.10`<br>JavaScript instrumentation uses the deprecated label name `net.peer.name`. |
| Client Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.peer.port`.        |
| Server Span `server.address` | `10.244.1.10`<br>JavaScript instrumentation uses the deprecated label name `net.host.name`. |
| Server Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.host.port`.        |
...
| Client Span `server.address` | `server-node-express.default.svc.cluster.local`<br>JavaScript instrumentation uses the deprecated label name `net.peer.name`.       |
| Client Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.peer.port`.                                                |
| Server Span `server.address` | `server-node-express.default.svc.cluster.local`<br>Node: JavaScript instrumentation uses the deprecated label name `net.host.name`. |
| Server Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.host.port`.                                                |
...
| Client Span `server.address` | `server-node-express.default`<br>JavaScript instrumentation uses the deprecated label name `net.peer.name`. |
| Client Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.peer.port`.                        |
| Server Span `server.address` | `server-node-express.default`<br>JavaScript instrumentation uses the deprecated label name `net.host.name`. |
| Server Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.host.port`.                        |
...
| Client Span `server.address` | `server-node-express`<br>JavaScript instrumentation uses the deprecated label name `net.peer.name`. |
| Client Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.peer.port`.                |
| Server Span `server.address` | `server-node-express`<br>JavaScript instrumentation uses the deprecated label name `net.host.name`. |
| Server Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.host.port`.                |
...
| Client Span `server.address` | `10.96.231.246`<br>JavaScript instrumentation uses the deprecated label name `net.peer.name`. |
| Client Span `server.port`    | `8080`<br>JavaScript instrumentation uses the deprecated label name `net.peer.port`.          |
